		...
		public static void addAirShipCraftingRecipes()
			{
				...
				GameRegistry.addRecipe(new ItemStack(AirShip.balloon, 1, 0),
				    new Object[]
...
//				            1, 0));
				...
				GameRegistry.addRecipe(new ItemStack(AirShip.engine, 1), new Object[]
					{ "###", "#X#", "###", "#", new ItemStack(Item.ingotIron), "X",
					    new ItemStack(Block.pistonBase) });

				GameRegistry.addRecipe(new ItemStack(AirShip.airShip, 1), new Object[]
					{ "XBX", "ECE", "XDX", "X", new ItemStack(Item.silk), "B",
